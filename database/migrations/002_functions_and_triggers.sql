...
-- Description: Create utility functions and triggers for AI Phrase
-- Created: 2025-01-09
...
-- Function to update file card counts
...
-- Trigger function for updating file card counts
...
-- Create trigger for automatic file count updates
DO $$ BEGIN
